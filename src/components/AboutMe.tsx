  ...
  return (
    <Container className="bg-zinc-700 text-zinc-200">
      ...
      <p className="text-base tracking-wide mt-4">
        ...
        odio sequi soluta? Laboriosam ducimus quidem aut eius saepe. Eaque earum
        impedit ullam quibusdam reiciendis itaque minima ipsum. Animi vitae
        quae.
      </p>
      <p className="mt-2">
        minima odit aperiam ratione magni dicta praesentium accusantium sapiente
        ipsam dolorum vel deleniti corporis voluptate quidem eum, sed
